...
st.title("Chapter 4: Filtering in the Frequency Domain")
st.write("Lọc ảnh trong miền tần số")

st.markdown(
    f"""<style>
    .stApp {{
    background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0jSbxkNzMcb_9boJIHCRJ41GdhyAlD5Sb5H5CrjkZd995VhxbnfnM3SHLG0NdBIdamFk&usqp=CAU");
...
if uploaded_file is not None:
    ...
    option = st.selectbox(
        ...
        ('Không', 'Spectrum', 'FrequencyFilter', 'CreateNotchRejectFilter', 'DrawNotchRejectFilter',
         'RemoveMoire')
    )
